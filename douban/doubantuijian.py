...
def getRightData(db_name, collection_name, document_number):
    ...
    if isinstance(db_name, str) and isinstance(collection_name, str):
        try:
...
if __name__ == '__main__':
    mydict = getRightData('doubanbooks', 'readers', 10)
    mydict['wufan'] = {'Nodejs实战': 4, '嫌疑人X的献身': 4, '鲁滨逊漂流记': 4,
                       '三体': 5, '三体Ⅱ': 4, '三体Ⅲ': 3, 'jQuery实战（第2版）': 5}
