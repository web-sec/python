...
csv_data = ReadCSVFile('../../info/cleandata_14w.csv')#读取文件
...
for type in kinds:
    ...
    if type_quantity <= 4000 and type_quantity > 1000:
        ...
        WriteTrainDataToCsv('LR','{len_types}/{len_all}'.format(len_types=type_quantity,len_all=len(product_component)),type,accuracy,precision,recall,f1,auc)
